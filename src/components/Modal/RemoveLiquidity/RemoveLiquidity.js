...
const RemoveLiquidity = (props) => {return null}
...
//   const init = async () => {
//     if (isUserConnected) {
//       const oneBalance = await ContractServices.getETHBalance(isUserConnected);
...
//       a1 = address;
//       if (address === 'BNB') {
//         oneBalance = await ContractServices.getETHBalance(isUserConnected);
//       } else {
...
//       a2 = address;
//       if (address === 'BNB') {
//         twoBalance = await ContractServices.getETHBalance(isUserConnected);
//       } else {
